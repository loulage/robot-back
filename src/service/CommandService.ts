...
import { createCommand, deleteCommand, getCommandById, listAllCommands, listAllCommandsByRobotId, updateCommandIsValid } from '../model/CommandRepository';
  ...
  export async function createCommandService(userInput: string, robotId: number, isValid: boolean): Promise<ICommandDTO> {
